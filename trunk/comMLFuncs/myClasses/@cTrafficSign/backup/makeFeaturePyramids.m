...
switch featureType
  ...
  case 'TrafficSignCIELab'
    pyrs = makeHuePyramid(img,salParams.pyramidType,trafficSignHueParams('cielab'),'TrafficSignCIELab');
    
  case 'RedTS_CIE' % RedTS_CIE: Red Traffic Sign Feature in CIE Colorspace
    pyrs = makeHuePyramid(img,salParams.pyramidType,trafficSignHueParams('RedTS_CIE'),'RedTS_CIE');

  case 'BlueTS_CIE' % BlueTS_CIE: Blue Traffic Sign Feature in CIE Colorspace
    pyrs = makeHuePyramid(img,salParams.pyramidType,trafficSignHueParams('BlueTS_CIE'),'BlueTS_CIE');    

  case 'YellowTS_CIE' % YellowTS_CIE: Yellow Traffic Sign Feature in CIE Colorspace
    pyrs = makeHuePyramid(img,salParams.pyramidType,trafficSignHueParams('YellowTS_CIE'),'YellowTS_CIE');        
    
  case 'GreenTS_CIE' % GreenTS_CIE: Green Traffic Sign Feature in CIE Colorspace
    pyrs = makeHuePyramid(img,salParams.pyramidType,trafficSignHueParams('GreenTS_CIE'),'GreenTS_CIE');        

  case 'BrownTS_CIE' % BrownTS_CIE: Brown Traffic Sign Feature in CIE Colorspace
    pyrs = makeHuePyramid(img,salParams.pyramidType,trafficSignHueParams('BrownTS_CIE'),'BrownTS_CIE');            

  case 'OrangeTS_CIE' % OrangeTS_CIE: Orange Traffic Sign Feature in CIE Colorspace
    pyrs = makeHuePyramid(img,salParams.pyramidType,trafficSignHueParams('OrangeTS_CIE'),'OrangeTS_CIE');                

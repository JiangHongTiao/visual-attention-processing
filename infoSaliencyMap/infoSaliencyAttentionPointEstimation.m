function aSaliencyScore = infoSaliencyAttentionPointEstimation(imgs,transEng,noCoff,Loc)
...
% imgs_6 imgs_7 imgs_8    
    ...
    if (xLoc > 22 && xLoc <= ncols - 22 && yLoc > 22 && yLoc <= nrows - 22)
        ...
        offset_y = 20*[ -1  -1  -1    ...
                         0      0    ...
                         1   1  1 ];
        % Define locations of squares in the vicinity 
        xP = double(xLoc) + (offset_x);
        yP = double(yLoc) + offset_y;  
